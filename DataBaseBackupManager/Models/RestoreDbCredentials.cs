namespace DataBaseBackupManager.Models
{
    ...
    /// </summary>
    public class RestoreDbCredentials : DbCredentials
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public RestoreDbCredentials(string host, int port, string database, string user, string password, string schema, string backupFileName)
